...
export const POLAROID_ROWS = [
  ...
  [{ id: 25, src: "/memories/Collage (Photo budka).png", rotation: -4 }, { id: 26, src: "/memories/DSC09666.JPG", rotation: 3 }, { id: 27, src: "/memories/IMG_1267.png", rotation: -3 }, { id: 28, src: "/memories/IMG_20250216_111400_549.png", rotation: 2 }, { id: 29, src: "/memories/Screenshot 2026-03-05 at 10.53.06.png", rotation: -5 }, { id: 30, src: "/memories/img_3749.jpg", rotation: 4 }],
  [{ id: 31, src: "/memories/Screenshot 2026-03-05 at 10.54.31.png", rotation: -3 }, { id: 32, src: "/memories/IMG_3896.JPG", rotation: 3 }, { id: 33, src: "/memories/IMG_5243.JPG", rotation: -2 }, { id: 34, src: "/memories/IMG_5652.JPG", rotation: 4 }, { id: 35, src: "/memories/IMG_5658.JPG", rotation: -5 }, { id: 36, src: "/memories/IMG_6162.JPG", rotation: 3 }],
  [{ id: 37, src: "/memories/IMG_7252.PNG", rotation: -3 }, { id: 38, src: "/memories/IMG_8408.JPG", rotation: 2 }, { id: 39, src: "/memories/IMG_8465.JPG", rotation: -4 }, { id: 40, src: "/memories/Screenshot 2026-03-05 at 10.54.43.png", rotation: 3 }, { id: 41, src: "/memories/IMG_9536.JPG", rotation: -2 }, { id: 42, src: "/memories/photo_2026-03-02 18.09.41.jpeg", rotation: 4 }],
                ...
                >
                  ...
                  <div className="relative bg-black shadow-2xl" style={{ width: '200px', height: '150px' }}>
                    ...
                    <div className="absolute top-4 bottom-4 left-0.5 right-0.5 bg-black overflow-hidden">
                      {/* Show poster image (no autoplay to save bandwidth) */}
                      <img
                        src={video.poster}
                        alt={video.original}
                        className="w-full h-full object-cover"
